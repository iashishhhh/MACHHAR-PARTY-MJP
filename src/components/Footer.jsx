      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <div className="text-center md:text-left cursor-pointer group" onClick={handleLogoClick}>
            <h3 className="text-3xl font-bebas text-glow-red text-mjp-red tracking-wider">
              MUCCHAR JANTA <span className="text-mjp-yellow text-glow-yellow">PARTY</span>
            </h3>
        ...
        <div className="border-t border-mjp-red/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <div className="flex items-start gap-2.5 max-w-xl text-gray-500 font-poppins text-[10px] md:text-xs leading-relaxed">
            ...
            <p>
              <strong>Campaign Disclaimer:</strong> Mucchar Janta Party (MJP) is a purely fictional political organization created for comedy, satire, and entertainment purposes. MJP is not liable for malaria, dengue, insomnia, sleep disturbances, platelet drops, or sudden midnight clapping urges. Blood extractions and midnight serenade buzzing are subject to sleep market risks. Read all campaign pamphlets carefully before closing your windows.
            </p>
          </div>
